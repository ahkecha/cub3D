...
#    Updated: 2022/06/20 20:02:02 by oabdelha         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS = mini_map_bonus.c mous_move_bonus.c
...
S_OBJECTS = $(addprefix $(OBJECT_PATH), $(SPARE:.c=.o))

B_OBJECTS = $(addprefix $(OBJECT_PATH), $(BONUS:.c=.o))
...
$(OBJECT_PATH)%.o : $(BONUS_PATH)%.c $(INCLUDE) $(CONSTANT)
	@$(CM) $(FLAG) -o $@  -c $<
...
bonus: fclean $(FOBJ_SRC) $(M_OBJECTS) $(B_OBJECTS) $(INCLUDE) $(CONSTANT)
	@cd libft; make
	@cc $(FLAG) $(M_OBJECTS) $(B_OBJECTS) libft/libft.a $(FLAG_MLX) mlx/libmlx.a -o cub3D
